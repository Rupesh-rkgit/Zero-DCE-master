...
class TfdataPipeline:
    ...
    def _load_and_split_dataset_files(self, path: str, split:float = 0.1)-> tuple[list,...]:
        '''
        ...
        print("total_image_count",total_image_size)
...
if __name__ == "__main__":
    BASE_DIR = '/content/drive/MyDrive/Zero-DCE-master/loldatasetv2/our485/low'
